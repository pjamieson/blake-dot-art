...
const PopArtPortfolioPage = ({ data }) => {
  ...
  const seo_description = "Illustrates pop art paintings by Blake Jamieson selected from the artist's portfolio, with links to detailed information about each painting."

  return (
    <Layout>
      <Seo title="Pop Art Portfolio" description={seo_description} />
